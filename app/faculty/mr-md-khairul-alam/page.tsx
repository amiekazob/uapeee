            ...
            {member.administrativeRoles && member.administrativeRoles.length > 0 && (
              <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  ...
                  Professional Consultancy & Sponsored Research
                </h2>
                <div className="space-y-4">
                  {member.administrativeRoles.map((role, index) => (
                    <div key={index} className="border-l-4 border-indigo-200 pl-4">
                      <h3 className="font-semibold text-gray-900">{role.title}</h3>
                      <p className="text-indigo-600">{role.organization}</p>
                    ...
                    <div key={index} className="p-4 bg-gray-50 rounded-lg">
                      <div className="flex items-start justify-between mb-2">
                        <Badge 
                          ...
                          className={publication.type === 'Journal' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'}
                        >
                          {publication.type}
                        </Badge>

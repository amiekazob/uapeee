                    ...
                    <div key={index} className="p-4 bg-gray-50 rounded-lg border-l-4 border-indigo-200">
                      <div className="flex items-start justify-between mb-2">
                        <Badge 
                          ...
                          className={publication.type === 'Journal' ? 'bg-blue-600 text-white' : 'bg-green-600 text-white'}
                        >
                          {publication.type}
                        </Badge>
                        <span className="text-sm text-gray-500 font-medium">{publication.year}</span>
                      </div>
                      <h4 className="font-semibold text-gray-900 mb-2 leading-tight">{publication.title}</h4>

      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Publications */}
            {member.recentPublications?.length > 0 && (
              <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                ...
                <div className="space-y-4">
                  {member.recentPublications.slice(0, 15).map((publication, index) => (
                    <div key={index} className="p-6 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg border-l-4 border-indigo-500 hover:shadow-md transition-shadow">
                      ...
                      <p className="text-sm text-indigo-700 font-medium mb-2">
                        <span className="text-gray-500">Published in:</span> {publication.venue}
                      </p>
                ...
                {member.recentPublications.length > 15 && (
                  <div className="mt-6 text-center">
                    <p className="text-sm text-gray-600">
                      Showing {Math.min(15, member.recentPublications.length)} of {member.recentPublications.length} publications
                    </p>
                  </div>
                )}
              </div>

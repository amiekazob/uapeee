              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
                ...
                <div className="space-y-6">
                  {member.academicExperience.map((exp, index) => (
                    <div key={index} className="border-l-4 border-indigo-200 pl-6 pb-4">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
                ...
                <div className="space-y-4">
                  {member.administrativeRoles.map((role, index) => (
                    <div key={index} className="border-l-4 border-green-200 pl-6 pb-4">
                      <h3 className="font-semibold text-gray-900">{role.role}</h3>
                      <p className="text-green-600 font-medium">{role.department}</p>
            ...
            {member.recentPublications && member.recentPublications.length > 0 && (
              <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
                ...
                {member.recentPublications.filter(pub => pub.type === "Journal").length > 0 && (
                  <div className="mb-8">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Journal Papers</h3>
                    <div className="space-y-4">
                ...
                {member.recentPublications.filter(pub => pub.type === "Conference").length > 0 && (
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Conference Papers</h3>
                    <div className="space-y-4">
                      {member.recentPublications
                        .filter(pub => pub.type === "Conference")
                        .slice(0, 15)
                        .map((paper, index) => (
                          <div key={index} className="p-4 bg-gray-50 rounded-lg border-l-4 border-green-200">
                            <h4 className="font-medium text-gray-900 mb-2">{paper.title}</h4>
                            <p className="text-sm text-gray-600 mb-1">{paper.authors}</p>

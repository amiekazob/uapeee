                  ...
                  {member.recentPublications.slice(0, 10).map((publication, index) => (
                    <div key={index} className="p-6 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg border-l-4 border-indigo-500 hover:shadow-md transition-shadow">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <span className="text-lg font-bold text-indigo-600">{publication.year}</span>
                      </div>
                      
                      <h4 className="font-semibold text-gray-900 mb-2 leading-relaxed">{publication.title}</h4>
                      ...
                      <div className="flex gap-3 mt-3">
                        {publication.doi && (
                          <a 
                            ...
                            className="text-xs bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full hover:bg-indigo-200 transition-colors font-medium"
                          >
                            DOI
                          </a>
                        )}

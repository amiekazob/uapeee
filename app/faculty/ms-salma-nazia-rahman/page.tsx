...
import { Mail, Phone, MapPin, Star, ArrowLeft, Award, Users, FileText, Calendar, Trophy, GraduationCap, Building } from 'lucide-react';
                ...
                <div className="space-y-4">
                  {member.recentPublications.slice(0, 10).map((pub, index) => (
                    <div key={index} className="bg-gray-50 p-4 rounded-lg">
                      ...
                      {pub.doi && pub.doi !== "Submitted" && (
                        <p className="text-xs text-blue-600 mt-1">DOI: {pub.doi}</p>
                      )}
                      {pub.doi === "Submitted" && (
                        <p className="text-xs text-orange-600 mt-1">Status: Submitted</p>
                      )}
                    </div>
                  ))}
                </div>

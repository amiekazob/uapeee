        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>The long-term goal of the EEE department is to become a major center of higher education and research in Electrical and Electronic Engineering both nationally and internationally. The department is modelled to provide excellent teaching and research facilities for students with  teachers of the highest quality along with well-equipped and spacious classrooms with modern instructional tools, library, laboratories and research centers in various branches of Electrical and Electronic Engineering. The department already has the necessary faculty, classroom and laboratory facilities to run undergraduate and graduate programs simultaneously.</li>
            </ul
          </div>
